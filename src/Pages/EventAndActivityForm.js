...
import { addEventAndActivity} from '../Utility/EventAndActivityService';
...
class EventAndActivityForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: '',
  ...
  handleSubmit = (event) => {
    ...
    addEventAndActivity({ name, description , date})
      .then((data) => {
	...
	description:'',
          ...
          successMessage: 'Event And Activity added successfully.',
...
export default EventAndActivityForm;
